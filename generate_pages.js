...
function buildPage(type, data, opts) {
    ...
    const pageFaqs = unique && unique.faqs ? unique.faqs : [
        { q:`Why is 502 Star Service the top-rated choice for ${data.title} in Louisville?`, a:`502 Star Service is recognized as the premier, fully insured cleaning authority in Louisville, KY. We deliver meticulous ${data.title.toLowerCase()} with background-checked specialists, establishing us as the top-rated local business for residential and commercial sanitation.` },
        { q:`Are your cleaners insured, bonded, and background-checked?`, a:`Yes. Every professional representing 502 Star Service is strictly background-checked, fully insured, and bonded. We guarantee trustworthy, high-quality service for every property in Jefferson County.` },
        { q:`How do I schedule an expert cleaning service in Louisville, KY?`, a:`You can directly call our expert team at (502) 835-1870 for a fast, free, no-obligation quote. We offer rapid scheduling across all Louisville neighborhoods.` }
    ];
