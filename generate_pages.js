...
function buildPage(type, data) {
    ...
    const pageTitle = `Top-Rated ${keyword} in ${locationStr} | 502 Star Service`;
    const pageDesc = `Our locally-owned 502 Star Service ${locationStr} team is available for all your ${keyword.toLowerCase()} needs. Learn more about our 5-star service!`;
...
<head>
    ...
    <script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"WebPage","@id":"${canonical}","url":"${canonical}","name":"${pageTitle}","isPartOf":{"@id":"https://www.502starservices.com/#website"},"about":{"@id":"https://www.502starservices.com/#organization"},"primaryImageOfPage":{"@id":"https://www.502starservices.com/#primaryimage"},"image":{"@id":"https://www.502starservices.com/#primaryimage"},"thumbnailUrl":"https://www.502starservices.com/images/logo.webp","datePublished":"2024-09-09T04:55:10+00:00","dateModified":"2026-03-03T18:16:30+00:00","description":"${pageDesc}","breadcrumb":{"@id":"${canonical}#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["${canonical}"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"https://www.502starservices.com/#primaryimage","url":"https://www.502starservices.com/images/logo.webp","contentUrl":"https://www.502starservices.com/images/logo.webp"},{"@type":"BreadcrumbList","@id":"${canonical}#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.502starservices.com/"},{"@type":"ListItem","position":2,"name":"${data.title}"}]},{"@type":"WebSite","@id":"https://www.502starservices.com/#website","url":"https://www.502starservices.com/","name":"502 Star Service","description":"Discover the Art of Clean Living","publisher":{"@id":"https://www.502starservices.com/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://www.502starservices.com/?s={search_term_string}"},"query-input":{"@type":"PropertyValueSpecification","valueRequired":true,"valueName":"search_term_string"}}],"inLanguage":"en-US"},{"@type":"LocalBusiness","@id":"https://www.502starservices.com/#organization","name":"502 Star Service","url":"https://www.502starservices.com/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"https://www.502starservices.com/#/schema/logo/image/","url":"https://www.502starservices.com/images/logo.webp","contentUrl":"https://www.502starservices.com/images/logo.webp","width":500,"height":500,"caption":"502 Star Service"},"image":{"@id":"https://www.502starservices.com/#/schema/logo/image/"},"telephone":"502-835-1870","openingHoursSpecification":[{"@type":"OpeningHoursSpecification","dayOfWeek":["Monday","Tuesday","Wednesday","Thursday","Friday"],"opens":"08:00","closes":"18:00"},{"@type":"OpeningHoursSpecification","dayOfWeek":["Saturday"],"opens":"09:00","closes":"16:00"},{"@type":"OpeningHoursSpecification","dayOfWeek":["Sunday"],"opens":"09:00","closes":"15:00"}],"address":{"@type":"PostalAddress","addressCountry":"US","addressLocality":"Louisville","addressRegion":"KY"},"contactPoint":{"@type":"ContactPoint","telephone":"502-835-1870","areaServed":"Louisville, Jeffersonville, Shively, St. Mathews, Anchorage, Shelbyville"}},{"@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is the difference between 502 Star Service and other cleaning companies?","acceptedAnswer":{"@type":"Answer","text":"502 Star Service is a locally-owned cleaning company in Louisville, KY. We give you back the time you deserve so that you can focus on what matters most. Our professional home cleaning team delivers unrivaled, worry-free results with a 100% satisfaction guarantee. We clean thoroughly and efficiently while respecting your space."}},{"@type":"Question","name":"Are your cleaning products safe for pets and children?","acceptedAnswer":{"@type":"Answer","text":"Yes! We know you strive to protect your kids and pets, and so do we. 502 Star Service uses high-quality, eco-friendly, and pet-safe cleaning products."}},{"@type":"Question","name":"Are your cleaners insured and bonded?","acceptedAnswer":{"@type":"Answer","text":"Yes, all 502 Star Service cleaners are fully insured and bonded so you can feel secure and confident in your home cleaning choice."}},{"@type":"Question","name":"How often should I schedule a deep cleaning service?","acceptedAnswer":{"@type":"Answer","text":"For most Louisville homeowners, a one-time deep cleaning every 6 to 12 months is sufficient. If you aren't receiving regular weekly or bi-weekly cleaning, you may want to schedule deep cleanings more frequently."}},{"@type":"Question","name":"Can I ask for special requests or request focus on certain areas?","acceptedAnswer":{"@type":"Answer","text":"Yes! We are happy to accommodate any special cleaning requests you may have. From de-griming baseboards and cleaning inside cabinets to removing pet hair from furniture, our Louisville team will customize the cleaning to your exact needs."}}]}]}</script>
    <!-- / Yoast SEO plugin. -->
...
async function run() {
    ...
    // Extract the Targeted Local SEO Content Block
    const seoBlockMatch = indexHtml.match(/<!-- Targeted Local SEO Content Block -->[\s\S]*?<\/section>/);
    let globalSeoBlock = seoBlockMatch ? seoBlockMatch[0] : '';
    ...
    for (let s of services) {
        ...
        let sSeoBlock = globalSeoBlock.replace(/House Cleaning Services/gi, s.title).replace(/house cleaning services/gi, s.title.toLowerCase());
        html = html.replace('<!-- _GLOBAL_HEAD_CSS_ -->', globalCss);
        html = html.replace('<!-- _GLOBAL_HEADER_ -->', globalHeader);
        html = html.replace('<!-- _GLOBAL_SEO_BLOCK_ -->', sSeoBlock);
    ...
    for (let l of locations) {
        ...
        let lSeoBlock = globalSeoBlock.replace(/Louisville KY/g, l.title + (l.title.includes(' KY') ? '' : ' KY')).replace(/Louisville/g, l.title);
        html = html.replace('<!-- _GLOBAL_HEAD_CSS_ -->', globalCss);
        html = html.replace('<!-- _GLOBAL_HEADER_ -->', globalHeader);
        html = html.replace('<!-- _GLOBAL_SEO_BLOCK_ -->', lSeoBlock);
        html = html.replace('<!-- _GLOBAL_FOOTER_ -->', globalFooterAndSections);
        savePage(l, html);
        totalCreated++;
    }
